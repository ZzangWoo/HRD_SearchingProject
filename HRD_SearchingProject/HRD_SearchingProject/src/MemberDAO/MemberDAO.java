...
public class MemberDAO {
	...
	public String App_SearchingBoard(String content) {
		...
		conn = DBConnect.getConnection();
		String query = "select * from bbsTable where bbsAvailable = 1 and bbsTitle like '%" + content + "%' or bbsContent like '%" + content + "%' order by bbsID desc";
	...
	/************************ 게시판 글쓰기 ***********************/
	public int App_BoardWrite(String title, String content, String userID) {
	...
	/********************* 게시글 삭제 *************************/
	public int App_BoardDelete(int bbsID) {
		
		PreparedStatement pstm = null;
		
		conn = DBConnect.getConnection();
		String query = "update bbsTable set bbsAvailable = 0 where bbsID = " + bbsID + ";";
	...
	/*********************** 게시글 수정 *************************/
	public int App_BoardModify(int bbsID, String bbsTitle, String bbsContent) {

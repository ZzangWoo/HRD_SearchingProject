...
public class SearchWholeFragment extends Fragment {
    ...
    String TAG = "SearchWholeFragment Log : ";
    ...
    String resultsWhole;
    String idxMonth = "1"; // 전체조회 하라는 걸 알려주는 값
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup fragmentView = (ViewGroup) inflater.inflate(R.layout.activity_search_whole_fragment, container, false);
        Log.i(TAG, "전체조회 호출");
